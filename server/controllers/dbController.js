...
dbController.getInterviews = (req, res, next) => {
  const queryText = `SELECT i.company, i.position, u.display_name as displayName, u.user_name as github_name, COUNT(q.id) as questionCount, i.id as interviewId, u.user_name, u.photo_url, i.notes, i.type, i.interview_date
